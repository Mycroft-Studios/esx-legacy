...
AddEventHandler('esx:onPlayerSpawn', function()
  ...
  SetPedMotionBlur(LocalPlayer.state.info.ped, false)
...
function OnPlayerDeath()
  ...
  SetPedMotionBlur(LocalPlayer.state.info.ped, true)
...
function GetClosestRespawnPoint()
  local PlyCoords = GetEntityCoords(LocalPlayer.state.info.ped)
...
function RemoveItemsAfterRPDeath()
  ...
  CreateThread(function()
    ESX.TriggerServerCallback('esx_ambulancejob:removeItemsAfterRPDeath', function()
      ...
      DoScreenFadeOut(800)
      RespawnPed(LocalPlayer.state.info.ped, RespawnCoords, ClosestHospital.heading)
...
function ProcessNewPosition()
  ...
  local rayHandle = StartShapeTestRay(pCoords.x, pCoords.y, pCoords.z + 0.5, behindCam.x, behindCam.y, behindCam.z, -1, LocalPlayer.state.info.ped, 0)
